...
// package.json
"dependencies": {
  "@tapslab/ui": "github:tpural/tapslab-ui#v0.1.0"
}
```
...
/* src/app/globals.css */
@import "tailwindcss";
@import "@tapslab/ui/themes.css";    /* defines the custom properties */
@import "@tapslab/ui/tailwind.css";  /* maps them onto utilities */
...
@source "../../node_modules/@tapslab/ui/src";
```

```tsx
// src/app/layout.tsx
import { ThemeProvider, themeScript } from "@tapslab/ui";
